...
const TABS = [
  {
    ...
    desc: "Business rules encoded once, then applied continuously across every transaction.",
  ...
  },
  {
    ...
    desc: "Automated matching across systems, schedules, and operating records.",
    ...
    features: [
      ...
      { key: "salesrecon", name: "Sales and Sell-Through Match", desc: "Primary sell-in and secondary sell-out matched so channel movement stays clear." },
    ],
  },
  {
    id: "exceptions",
    ...
    desc: "Exceptions prioritised, assigned, and routed before they compound.",
  ...
  },
  {
    ...
    desc: "Routine approvals, alerts, and routing running continuously in the background.",
    ...
    features: [
      ...
      { key: "routing", name: "Exception Routing", desc: "Flagged items assigned automatically with context and suggested action attached." },
    ],
  },
];
...
export function CanyonGridExperience() {
  ...
  const activeFeatureMeta = activeTab.features.find((f) => f.key === activeFeature) ?? activeTab.features[0];
  const handleTabKeyDown = (event: KeyboardEvent<HTMLButtonElement>, currentTab: string) => {
    ...
    setTab(nextTab);
    requestAnimationFrame(() => document.getElementById(`cg-tab-${nextTab}`)?.focus());
  };
  ...
  return (
    <div className="cg">
          ...
          <div className="cg-tab-header" role="tablist" aria-label="Canyon Grid capabilities">
            {TABS.map((t) => (
              <button
                ...
                role="tab"
                id={`cg-tab-${t.id}`}
                aria-controls="cg-product-panel"
          ...
          >
            <div className="cg-product-layout">
              ...
              <div className="cg-product-screen">
                <div className="cg-screen-shell" role="region" aria-label={`${activeTab.screenName}: ${activeFeatureMeta.name}`}>
                  ...
                  <div className="cg-screen-view" key={`${tab}-${activeFeature}`}>
                    <ScreenBody tab={tab} feature={activeFeature} />
                  </div>
                  <div className="cg-preview-controls" aria-hidden="true">
                    <span />
                    <i />
                    <em />
                  </div>
                  <div className="cg-screen-caption" aria-live="polite">
                    <span>{activeFeatureMeta.name}</span>
        ...
        <div className="container">
          ...
          <div className="cg-flow">
            ...
            <div className="cg-flow-block">
              ...
              <div className="cg-flow-name">Activate</div>
      ...
      <section className="cg-cta">
        <div className="container">
          <div className="cg-cta-shell">
            <div className="cg-cta-copy">
              <span className="cg-cta-kicker">Next step</span>
