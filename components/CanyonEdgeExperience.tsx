...
const TABS = [
  {
    ...
    desc: "Role-specific live views for sales, supply chain, finance, and field teams.",
  ...
  },
  {
    ...
    desc: "Signals surfaced early, routed with context, and ready for action.",
    ...
    features: [
      ...
      { key: "opportunities", name: "Opportunity Signals", desc: "Upsell moments, relationship opportunities, and timing signals surfaced early." },
    ],
  },
  {
    id: "ask",
    ...
    desc: "Plain-language questions answered from your own operating data in seconds.",
  ...
  },
  {
    ...
    desc: "A live leadership view across every function, priority, and exception.",
...
export function CanyonEdgeExperience() {
  ...
  const handleTabKeyDown = (event: KeyboardEvent<HTMLButtonElement>, currentTab: string) => {
    ...
    setTab(nextTab);
    requestAnimationFrame(() => document.getElementById(`ce-tab-${nextTab}`)?.focus());
  };
    ...
    <div className="ce">
      ...
      <section className="ce-tab-section" id="ce-products">
        <div className="container">
          <div className="ce-tab-header" role="tablist" aria-label="Canyon Edge capabilities">
            {TABS.map((t) => (
              <button
                ...
                role="tab"
                id={`ce-tab-${t.id}`}
                aria-controls="ce-product-panel"
          ...
          <div
            className="ce-product-panel"
            id="ce-product-panel"
            role="tabpanel"
            aria-labelledby={`ce-tab-${tab}`}
          >
            <div className="ce-product-layout">
              <div className="ce-product-copy">
                <p className="section-label">{activeTab.tag}</p>
                <h2 className="ce-product-title">
                  {activeTab.id === "intelligence" ? (
                    <>
                      <span>The right intelligence</span>
                      <span>for every person in</span>
                ...
                <div className="ce-feature-list" role="group" aria-label={`${activeTab.tag} preview options`}>
              ...
              <div className="ce-product-screen">
                <div className="ce-screen-shell" role="region" aria-label={`${activeTab.screenName}: ${activeFeatureMeta.name}`}>
                  ...
                  <div className="ce-screen-view" key={`${tab}-${activeFeature}`}>
                    <ScreenBody tab={tab} feature={activeFeature} />
                  </div>
                  <div className="ce-preview-controls" aria-hidden="true">
                    <span />
                    <i />
                    <em />
                  </div>
                  <div className="ce-screen-caption" aria-live="polite">
        ...
        <div className="container">
          ...
          <div className="ce-flow">
            ...
            <div className="ce-flow-block highlight">
              ...
              <div className="ce-flow-name">Activate</div>
