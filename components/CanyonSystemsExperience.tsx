...
const TABS = [
  {
    ...
    desc: "Every visit, order, and outlet interaction captured live, structured, and ready for the intelligence layer.",
    ...
    features: [
      ...
      { key: "nudge", name: "Daily Nudges and Alerts", desc: "The right signal reaches the right owner before the moment passes." },
    ],
  },
  {
    id: "crm",
    ...
    desc: "Every relationship, opportunity, and follow-up owned in one commercial operating view.",
...
export function CanyonSystemsExperience() {
  ...
  const handleTabKeyDown = (event: KeyboardEvent<HTMLButtonElement>, currentTab: string) => {
    ...
    setTab(nextTab);
    requestAnimationFrame(() => document.getElementById(`cs-tab-${nextTab}`)?.focus());
  };
  ...
  return (
    <div className="cs">
          ...
          <div className="cs-tab-header" role="tablist" aria-label="Canyon Systems capabilities">
            {TABS.map((t) => (
              <button
                ...
                role="tab"
                id={`cs-tab-${t.id}`}
                aria-controls="cs-product-panel"
          ...
          >
            <div className="cs-product-layout">
              <div className="cs-product-copy">
                ...
                <h2 className="cs-product-title">
                  {activeTab.id === "sfa" ? (
                    <>
                      ...
                      <span>running on real data.</span>
                    </>
                  ) : (
                    activeTab.title
                  )}
                ...
                <div className="cs-feature-list" role="group" aria-label={`${activeTab.tag} preview options`}>
              ...
              <div className="cs-product-screen">
                <div className="cs-screen-shell" role="region" aria-label={`${activeTab.screenName}: ${activeFeatureMeta.name}`}>
                  ...
                  <div className="cs-screen-view" key={`${tab}-${activeFeature}`}>
                    <ScreenBody tab={tab} feature={activeFeature} />
                  </div>
                  <div className="cs-preview-controls" aria-hidden="true">
                    <span />
                    <i />
                    <em />
                  </div>
                  <div className="cs-screen-caption" aria-live="polite">
        ...
        <div className="container">
          ...
          <div className="cs-flow">
            ...
            <div className="cs-flow-block">
              ...
              <div className="cs-flow-name">Activate</div>
      ...
      <section className="cs-cta">
        <div className="container">
          <div className="cs-cta-shell">
            <div className="cs-cta-copy">
              <span className="cs-cta-kicker">Next step</span>
              <h2 className="cs-cta-title">Ready to start capturing?</h2>
            </div>
            <div className="cs-cta-panel">
              <p className="cs-cta-body">
                Every engagement starts with a Discovery Workshop — where we map what data you have, what is missing,
